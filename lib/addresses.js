...
AddressController.prototype.hunshow = function(req, res) {
  var self = this;
  var options = {
    noTxList: parseInt(req.query.noTxList)
  };
  ...
  this.getAddressSummary2(req.addr, options, function(err, data) {
    if(err) {
      return self.common.handleErrors(err, res);
    }
...
AddressController.prototype.getAddressSummary2 = function(address, options, callback) {  // huns 20190828
