...
function AddressController1(opts) {
  this.node = opts.node;
  this.txController = opts.txController;
  this.common = new Common({log: this.node.log});
}

AddressController1.prototype.show = function(req, res) {
  var self = this;
  var options = {
...
AddressController1.prototype.balancesum = function(req, res) {
...
AddressController1.prototype.balance = function(req, res) {
  this.addressSummarySubQuery(req, res, 'balanceSat');
};

AddressController1.prototype.totalReceived = function(req, res) {
  this.addressSummarySubQuery(req, res, 'totalReceivedSat');
};

AddressController1.prototype.totalSent = function(req, res) {
  this.addressSummarySubQuery(req, res, 'totalSentSat');
};

AddressController1.prototype.unconfirmedBalance = function(req, res) {
  this.addressSummarySubQuery(req, res, 'unconfirmedBalanceSat');
};

AddressController1.prototype.addressSummarySubQuery = function(req, res, param) {
  var self = this;
...
AddressController1.prototype.getAddressSummary = function(address, options, callback) {
...
AddressController1.prototype.getAddressSummary1 = function(address, options, callback) {
...
AddressController1.prototype.checkAddr = function(req, res, next) {
  req.addr = req.params.addr;
  this.check(req, res, next, [req.addr]);
};

AddressController1.prototype.checkAddrs = function(req, res, next) {
  if(req.body.addrs) {
...
AddressController1.prototype.check = function(req, res, next, addresses) {
  var self = this;
...
AddressController1.prototype.utxoWithoutMempool = function(req, res) {
    var self = this;
...
AddressController1.prototype.utxo = function(req, res) {
  var self = this;
...
AddressController1.prototype.multiutxo = function(req, res) {
  var self = this;
...
AddressController1.prototype.transformUtxo = function(utxoArg) {
  var utxo = {
  ...
  if (utxoArg.height && utxoArg.height > 0) {
    ...
    utxo.confirmations = this.node.services.ajwmd.height - utxoArg.height + 1;
  } else {
...
AddressController1.prototype._getTransformOptions = function(req) {
  return {
...
AddressController1.prototype.multitxs = function(req, res, next) {
  var self = this;
...
AddressController1.prototype.transformAddressHistoryForMultiTxs = function(txinfos, options, callback) {
  var self = this;
...
AddressController1.prototype.listUnspent = function(req, res, next) {
    var self = this,
...
AddressController1.prototype.createaddress = function(req, res, next) {
    var self = this;
...
module.exports = AddressController1;
