...
StatisticService.prototype.start = function (callback) {
    ...
    return async.waterfall([function (callback) {
        ...
        self.node.services.ajwmd.on('tip', self._rapidProtectedUpdateTip.bind(self));
...
StatisticService.prototype.getTotalSupply  = function() {
    var blockHeight = this.node.services.ajwmd.height;

    var supply = (new BigNumber(77000000000)).plus((blockHeight - 5000) * 5);
